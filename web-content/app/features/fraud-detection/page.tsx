				...
				<div className=' grid grid-cols-1 md:grid-cols-3 gap-3'>
						...
						children={
							<div>
								...
								<p className=' font-normal text-sm text-gray-slate-600'>
									Claude excels in understanding complex
									patterns and generating insights from
								...
								<ul className=' font-normal text-sm text-gray-slate-600 list-disc pl-5'>
									...
									<li>
										...
										encryption for sensitive transaction
										data.
									</li>
								</ul>
							</div>
					...
					<CardBox
						...
						children={
							<div>
								<p className=' font-normal text-sm text-gray-slate-600'>
									Payment Verification to Prevent Fraud within
									the Financial Services Industry. Using
									various Financial Advisors from 5 different
									financial institutions in the UK & Africa
								</p>
								<p className=' font-normal text-sm text-gray-slate-600 py-2'>
									Put Financial Advisors on a web application
									such that capabilities to detect fraudulent
									transactions are shown, we would also be
									displaying a Dashboard (Risk/Fraud Persona)
								</p>
							</div>
						}
					/>
							...
							<div>
								<ul className=' font-normal text-sm text-gray-slate-600 list-disc pl-5'>
									<li>
										...
										>
											IBM Transactions for Anti-Money
											Laundering (AML)
										</Link>
									</li>
									<li>
					...
					<CardBox
						...
						children={
							<div>
								...
								<p className=' font-normal text-sm text-gray-slate-600'>
									Analyze transactions and flag potential
									laundering.
								</p>
								<h4 className=' text-black-slate-900 text-sm font-semibold my-2'>
									Method:
